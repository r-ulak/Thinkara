...
(function ($) {
    ...
    $.widget('ui.tagit', {
        ...
        assignedTagsDataId: function () {
            // Only to be used when singleField option is not seletced
            var tags = [];

            this.tagList.children('.tagit-choice').each(function () {
                tags.push($(this).data('tag_item_data').id);
            });
            return tags;

        },
        assignedTagsDataIdandType: function () {
            // Only to be used when singleField option is not seletced
            var tags = [];
            this.tagList.children('.tagit-choice').each(function () {
                tags.push({ "ACLId": $(this).data('tag_item_data').id, "ACLType": $(this).data('tag_item_data').type });
            });
            return tags;
