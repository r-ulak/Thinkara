...
namespace GrowSocialAssetJob
{
    class GrowSocialAssetJob
    {
        static void Main(string[] args)
        {
            ...
            {
                GrowSocialAssetManager socialManager = new GrowSocialAssetManager();
                int runId = jobmanager.GetRunId();
                socialManager.SendEmailNotification(runId);
            }
            else
            {
