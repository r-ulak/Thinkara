...
namespace PlanetMobileService
{
    public partial class Startup
    {
        ...
        static Startup()
        {
            ...
            (new MySqlUserStore<IdentityUser>());
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            x.AppId = ConfigurationManager.AppSettings["MS_FacebookAppID"];
            x.AppSecret = ConfigurationManager.AppSettings["MS_FacebookAppSecret"];
