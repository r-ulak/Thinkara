...
LOAD DATA LOCAL INFILE '/home/planetx/DbScripts/BootStrap/Data/UserBankAccount.csv' INTO TABLE UserBankAccount FIELDS TERMINATED BY ',' SET CreatedAT = UTC_TIMESTAMP(), UpdatedAT = UTC_TIMESTAMP();
LOAD DATA LOCAL INFILE '/home/planetx/DbScripts/BootStrap/Data/StockTrade.csv' INTO TABLE StockTrade FIELDS TERMINATED BY ',' SET UpdatedAT = UTC_TIMESTAMP();
LOAD DATA LOCAL INFILE '/home/planetx/DbScripts/BootStrap/Data/UserStock.csv' INTO TABLE UserStock FIELDS TERMINATED BY ',' SET PurchasedAT = UTC_TIMESTAMP();
