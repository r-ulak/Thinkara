...
namespace PlanetGeni.ContentProviders
{
    public class YouTubeContentProvider : EmbedContentProvider
    {
        ...
        public override string MediaFormatString
        {
            get
            {
                return @"<object ><param name=""WMode"" value=""transparent""></param><param name=""movie"" value=""https://www.youtube.com/v/{0}fs=1""></param><param name=""allowFullScreen"" value=""true""></param><param name=""allowScriptAccess"" value=""always""></param><embed src=""https://www.youtube.com/v/{0}?fs=1"" wmode=""transparent"" type=""application/x-shockwave-flash"" allowfullscreen=""true"" allowscriptaccess=""always"" ></embed></object>";
            }
        }
